...
describe('Should return proper yaku data', () => {
  ...
  it('Should parse Pinfu, sanshoku, tanyao', () => {
    const r = new Riichi([p2, p3, p4, p5, p6, p7, m5, m6, m7, s5, s6, s7, s3, s3], [], {
      bakaze: e,
      jikaze: w,
    });
    const res = r.calc();
  ...
  it('Should parse Pinfu iipeiko chinitsu tanyao', () => {
    ...
    assert.deepStrictEqual(res, {
      ...
      ten: 24000,
      text: '',
      yaku: { chinitsu: 6, iipeikou: 1, menzentsumo: 1, pinfu: 1, tanyao: 1 },
      yakuman: 0,
    });
  });
