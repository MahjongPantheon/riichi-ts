          ...
          for (const idx in hands) {
            ...
            try {
              ...
              const options = {
                ...
                tile_discarded_by_someone: data.takenTile === undefined ? -1 : toRrsOne(data.takenTile),
                first_take: data.yakuman.includes('tenhou') ||
...
function toYakuNames(y: string): string {
  switch (parseInt(y, 10) as Yaku) {
    case Yaku.Kokushimusou13Sides: return 'kokushimusou 13 sides';
    case Yaku.Kokushimusou: return 'kokushimusou';
    case Yaku.Chuurenpoto9Sides: return 'chuurenpoto 9 sides';
    case Yaku.Chuurenpoto: return 'chuurenpoto';
    case Yaku.SuuankouTanki: return 'suuankou tanki';
    case Yaku.Suuankou: return 'suuankou';
    case Yaku.Daisuushi: return 'daisuushi';
    case Yaku.Shosuushi: return 'shosuushi';
    ...
    case Yaku.Tenhou: return 'tenhou';
    case Yaku.Chihou: return 'chihou';
    case Yaku.Renhou: return 'renhou';
    case Yaku.Daisharin: return '';
    ...
    case Yaku.Shosangen: return 'shosangen';
    case Yaku.SanshokuDoukou: return 'sanshoku doukou';
    case Yaku.Sanankou: return 'sanankou';
    case Yaku.Chiitoitsu: return 'chiitoitsu';
    case Yaku.DaburuRiichi: return 'daburu riichi';
    case Yaku.Ittsu: return 'ittsu';
    case Yaku.Sanshoku: return 'sanshoku';
    case Yaku.Tanyao: return 'tanyao';
    case Yaku.Pinfu: return 'pinfu';
    case Yaku.Iipeikou: return 'iipeikou';
    case Yaku.Menzentsumo: return 'menzentsumo';
    case Yaku.Riichi: return 'riichi';
    case Yaku.Ippatsu: return 'ippatsu';
    case Yaku.Rinshan: return 'rinshan';
    case Yaku.Chankan: return 'chankan';
    case Yaku.Haitei: return 'haitei';
    case Yaku.Houtei: return 'houtei';
    case Yaku.RoundWindEast: return 'round wind east';
    case Yaku.RoundWindSouth: return 'round wind south';
    case Yaku.RoundWindWest: return 'round wind west';
    case Yaku.RoundWindNorth: return 'round wind north';
    case Yaku.OwnWindEast: return 'own wind east';
    case Yaku.OwnWindSouth: return 'own wind south';
    case Yaku.OwnWindWest: return 'own wind west';
    case Yaku.OwnWindNorth: return 'own wind north';
    case Yaku.Haku: return 'haku';
    case Yaku.Hatsu: return 'hatsu';
    case Yaku.Chun: return 'chun';
    case Yaku.Dora: return 'dora';
    case Yaku.Uradora: return 'uradora';
    case Yaku.Akadora: return 'akadora';
    default: return '';
  }
}
